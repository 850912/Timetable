...
fun PowerSaveModeSelectPager(config: AppConfig, onSelect: (AppPowerSaveMode) -> Unit) {
    val values = listOf(
        AppPowerSaveMode.FOLLOW_SYSTEM to (stringResource(R.string.settings_power_follow) to stringResource(R.string.settings_power_follow_summary)),
        AppPowerSaveMode.ALWAYS_ON to (stringResource(R.string.settings_power_on) to stringResource(R.string.settings_power_on_summary)),
        AppPowerSaveMode.ALWAYS_OFF to (stringResource(R.string.settings_power_off) to stringResource(R.string.settings_power_off_summary))
    )
