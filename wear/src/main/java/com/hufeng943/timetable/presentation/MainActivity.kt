...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val currentThemePreset by themePreference.themePresetFlow.collectAsState(initial = com.hufeng943.timetable.presentation.ui.theme.ThemePreset.AMOLED_BLACK)
