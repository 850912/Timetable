...
class SyncCoordinator(
    ...
    companion object {
        // All coordinators in this process share one gate. Job, reconnect and manual sync
        // must not concurrently mutate retry/ACK state.
        private val processMutex = Mutex()
    }

    suspend fun syncPending(): SyncResult = processMutex.withLock {
