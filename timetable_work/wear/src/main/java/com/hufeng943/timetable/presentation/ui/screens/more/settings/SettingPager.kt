...
fun SettingPager(
    ...
    val currentReminderLabel = config.courseReminderMinutes?.let {
        stringResource(R.string.settings_course_reminder_minutes, it)
    ...
    ScreenScaffold(
        ...
        TransformingLazyColumn(state = scrollState, contentPadding = contentPadding) {
            ...
            item { SettingItemCard(Icons.Rounded.NotificationsActive, stringResource(R.string.settings_course_reminder), currentReminderLabel, transformationSpec, onReminderSelectClick) }
